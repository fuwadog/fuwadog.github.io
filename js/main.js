...
// Observer for Sticky Navbar
// We watch a sentinel element at the top of the body
const headerSentinel = document.createElement("div");
headerSentinel.style.position = "absolute";
headerSentinel.style.top = "50px"; // Trigger after 50px
headerSentinel.style.height = "1px";
headerSentinel.style.width = "1px";
headerSentinel.style.pointerEvents = "none";
headerSentinel.style.visibility = "hidden";
...
// Utilities removed as IntersectionObserver replaces scroll/resize listeners
